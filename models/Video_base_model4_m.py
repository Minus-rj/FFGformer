...
import models.archs.FFGformer as FFGformer
...
class VideoBaseModel(BaseModel):
    def __init__(self, opt):
        ...
        self.netG = FFGformer.FFGformer().to(self.device)
    ...
    def optimize_parameters(self, step):
        ...
        out = torch.cat((self.var_L, self.fake_H, self.real_H), 3)
        from utils import util
        util.save_img(util.tensor2img(out.detach().float().cpu()), './figure/real_H.jpg')

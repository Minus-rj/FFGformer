...
def create_dataset(dataset_opt):
    ...
    elif mode == 'video_samesize_HICRD':
        from data.dataset_HICRD import VideoSameSizeDataset as D
    elif mode == 'video_samesize_UIEB':
        from data.dataset_UIEB import VideoSameSizeDataset as D
    else:

...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default='./options/test/TURBID.yml')
...
def main():
    ...
    save_folder = opt['path']['save_folder']
    ...
    for phase, dataset_opt in opt['datasets'].items():
        ...
        for val_data in val_loader:
            ...
            save_img_path = osp.join(save_folder, folder)
